...
var md22 = new i2c(md22_address, {device: '/dev/i2c-1'});
...
function setOperationMode(mode) {
    md22.writeBytes(0, [mode], function(err) {});
}

function stopRotation() {
    md22.writeBytes(1, [128], function(err) {});
    md22.writeBytes(2, [128], function(err) {});
}

function setMotorsWithTurn(speed, turn) {
    md22.writeBytes(1, [speed], function(err) {});
    md22.writeBytes(2, [turn], function(err) {});
}
